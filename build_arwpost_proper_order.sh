#!/bin/bash
# Build ARWpost with Proper Module Compilation Order
# This script compiles modules in the correct dependency order

set -e  # Exit on any error

echo "=== ARWpost Build with Proper Module Order ==="
echo "Building ARWpost by compiling modules in dependency order..."
echo ""
...
# Level 3: Grid and input modules (depend on basic modules)
echo "Level 3: Grid and input modules (depend on basic modules)"
GRID_MODULES=(
...
# Level 4: Calculation modules (depend on grid modules)
echo "Level 4: Calculation modules (depend on grid modules)"
CALC_MODULES=(
...
# Level 5: Output module (depend on calculation modules)
echo "Level 5: Output module (depend on calculation modules)"
...
# Level 6: Process domain module (depend on output module)
echo "Level 6: Process domain module (depend on output module)"
