#!/bin/bash
# Complete ARWpost Build Script for Lengau Cluster
# This script builds the full ARWpost with all processing capabilities

set -e  # Exit on any error

echo "=== Complete ARWpost Build Script ==="
echo "Building full ARWpost with all processing capabilities..."
echo ""
...
if [ -f "ARWpost" ]; then
    ...
    # Complex modules (depend on calculation modules)
    COMPLEX_MODULES=(
